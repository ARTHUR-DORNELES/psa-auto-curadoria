...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ mensagem: 'Tive um probleminha aqui do meu lado. Pode repetir, por favor?', slots, widget: null, erro: true, detalhe: String((e && e.message) || e).slice(0, 700) });
  }
}
